...
class SeoulLandSpots {
  static const LatLng center = LatLng(37.4279, 126.9798);
  ...
  static const List<Spot> all = [
    ...
    Spot(
      ...
      position: LatLng(37.4291, 126.9782),
    ...
    Spot(
      ...
      position: LatLng(37.4295, 126.9779),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      name: '후룸라이드',
      nameEn: 'Flume Ride',
      position: LatLng(37.4284, 126.9806),
      category: SpotCategory.attraction,
      themes: [SpotTheme.thrill, SpotTheme.family],
      icon: '🌊',
    ...
    Spot(
      ...
      name: '자이로스윙',
      nameEn: 'Gyro Swing',
      position: LatLng(37.4272, 126.9792),
      category: SpotCategory.attraction,
      themes: [SpotTheme.thrill],
      icon: '🎡',
    ...
    Spot(
      ...
      name: '킹바이킹',
      nameEn: 'King Viking',
      position: LatLng(37.4268, 126.9788),
      category: SpotCategory.attraction,
      themes: [SpotTheme.thrill, SpotTheme.family],
      icon: '⚓',
    ...
    Spot(
      ...
      name: '급류타기',
      nameEn: 'Rapid Ride',
      position: LatLng(37.4266, 126.9803),
      category: SpotCategory.attraction,
      themes: [SpotTheme.thrill, SpotTheme.family],
      icon: '🚤',
    ...
    Spot(
      ...
      name: '대관람차',
      nameEn: 'Ferris Wheel',
      position: LatLng(37.4282, 126.9813),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      name: '회전목마',
      nameEn: 'Carousel',
      position: LatLng(37.4278, 126.9809),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      name: '범퍼카',
      nameEn: 'Bumper Car',
      position: LatLng(37.4274, 126.9799),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      name: '해적소굴',
      nameEn: 'Pirate Cave',
      position: LatLng(37.4263, 126.9794),
      category: SpotCategory.attraction,
      themes: [SpotTheme.family],
      icon: '🏴‍☠️',
    ...
    Spot(
      ...
      position: LatLng(37.4298, 126.9785),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      name: '스카이X',
      nameEn: 'Sky X',
      position: LatLng(37.4300, 126.9789),
      category: SpotCategory.attraction,
      themes: [SpotTheme.thrill],
      icon: '🚀',
    ...
    Spot(
      ...
      name: 'VR게이트',
      nameEn: 'VR Gate',
      position: LatLng(37.4276, 126.9817),
      category: SpotCategory.attraction,
      themes: [SpotTheme.family, SpotTheme.thrill],
      icon: '🥽',
    ...
    Spot(
      ...
      name: '빅회전목마',
      nameEn: 'Big Carousel',
      position: LatLng(37.4270, 126.9810),
      category: SpotCategory.attraction,
    ...
    Spot(
      ...
      position: LatLng(37.4280, 126.9795),
      category: SpotCategory.attraction,
      themes: [SpotTheme.family, SpotTheme.relaxed],
      icon: '🐘',
    ...
    Spot(
      ...
      position: LatLng(37.4277, 126.9811),
    ...
    Spot(
      ...
      position: LatLng(37.4282, 126.9801),
      category: SpotCategory.food,
    ...
    Spot(
      ...
      name: '카레원',
      nameEn: 'Curry One',
      position: LatLng(37.4271, 126.9804),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🍛',
    ...
    Spot(
      ...
      name: '부자분식',
      nameEn: 'Buja Snack',
      position: LatLng(37.4265, 126.9799),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🌭',
    ...
    Spot(
      ...
      name: '롯데리아',
      nameEn: 'Lotteria',
      position: LatLng(37.4288, 126.9793),
      category: SpotCategory.food,
      themes: [SpotTheme.food, SpotTheme.family],
      icon: '🍔',
    ...
    Spot(
      ...
      name: '쥬라기 바베큐',
      nameEn: 'Jurassic BBQ',
      position: LatLng(37.4260, 126.9809),
      category: SpotCategory.food,
      themes: [SpotTheme.food, SpotTheme.family],
      icon: '🍖',
    ...
    Spot(
      ...
      position: LatLng(37.4286, 126.9819),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🚚',
    ...
    Spot(
      ...
      position: LatLng(37.4275, 126.9806),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🍜',
    ...
    Spot(
      ...
      position: LatLng(37.4277, 126.9786),
      category: SpotCategory.food,
      themes: [SpotTheme.food, SpotTheme.family],
      icon: '🍗',
    ...
    Spot(
      ...
      position: LatLng(37.4274, 126.9784),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🌯',
    ...
    Spot(
      ...
      name: '포메인',
      nameEn: 'Pho Mayne',
      position: LatLng(37.4279, 126.9789),
      category: SpotCategory.food,
      themes: [SpotTheme.food],
      icon: '🍝',
    ...
    Spot(
      ...
      name: '초당 순두부',
      nameEn: 'Chodang Tofu',
      position: LatLng(37.4269, 126.9815),
      category: SpotCategory.food,
      themes: [SpotTheme.food, SpotTheme.family],
      icon: '🥘',
    ...
    Spot(
      ...
      position: LatLng(37.4283, 126.9798),
    ...
    Spot(
      ...
      position: LatLng(37.4283, 126.9814),
      category: SpotCategory.photo,
    ...
    Spot(
      ...
      position: LatLng(37.4290, 126.9809),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🌸',
    ...
    Spot(
      ...
      position: LatLng(37.4278, 126.9808),
      category: SpotCategory.photo,
    ...
    Spot(
      ...
      position: LatLng(37.4280, 126.9816),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '⛲',
    ...
    Spot(
      ...
      position: LatLng(37.4296, 126.9786),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🛸',
    ...
    Spot(
      ...
      position: LatLng(37.4287, 126.9821),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🌃',
    ...
    Spot(
      ...
      position: LatLng(37.4273, 126.9794),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🦑',
    ...
    Spot(
      ...
      position: LatLng(37.4288, 126.9812),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🍂',
    ...
    Spot(
      ...
      position: LatLng(37.4261, 126.9807),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '🦕',
    ...
    Spot(
      ...
      position: LatLng(37.4285, 126.9803),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '✨',
    ...
    Spot(
      ...
      position: LatLng(37.4278, 126.9820),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🪩',
    ...
    Spot(
      ...
      position: LatLng(37.4292, 126.9781),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🚂',
    ...
    Spot(
      ...
      position: LatLng(37.4265, 126.9791),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '🏴‍☠️',
    ...
    Spot(
      ...
      position: LatLng(37.4259, 126.9813),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '⛷️',
    ...
    Spot(
      ...
      name: '무지개 게이트',
      nameEn: 'Rainbow Gate',
      position: LatLng(37.4276, 126.9792),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🌈',
    ...
    Spot(
      ...
      position: LatLng(37.4270, 126.9802),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '🐇',
    ...
    Spot(
      ...
      position: LatLng(37.4302, 126.9797),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🌳',
    ...
    Spot(
      ...
      position: LatLng(37.4267, 126.9811),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '🎭',
    ...
    Spot(
      ...
      position: LatLng(37.4294, 126.9813),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '☁️',
    ...
    Spot(
      ...
      position: LatLng(37.4284, 126.9820),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '💡',
    ...
    Spot(
      ...
      position: LatLng(37.4258, 126.9818),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🏞️',
    ...
    Spot(
      ...
      position: LatLng(37.4262, 126.9803),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🌺',
    ...
    Spot(
      ...
      position: LatLng(37.4305, 126.9807),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.relaxed],
      icon: '🏔️',
    ...
    Spot(
      ...
      position: LatLng(37.4269, 126.9797),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🎮',
    ...
    Spot(
      ...
      position: LatLng(37.4275, 126.9783),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🏰',
    ...
    Spot(
      ...
      position: LatLng(37.4289, 126.9799),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🫧',
    ...
    Spot(
      ...
      position: LatLng(37.4291, 126.9795),
      category: SpotCategory.photo,
    ...
    Spot(
      ...
      position: LatLng(37.4264, 126.9817),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo, SpotTheme.family],
      icon: '🎒',
    ...
    Spot(
      ...
      position: LatLng(37.4279, 126.9799),
      category: SpotCategory.photo,
      themes: [SpotTheme.photo],
      icon: '🎆',

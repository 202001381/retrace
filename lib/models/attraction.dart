...
const List<Attraction> kAttractions = [
  ...
  Attraction(
    ...
    category: '어트랙션',
    zone: '캐릭터 타운',
    lat: 37.4329, lng: 127.0189,
    indoor: false, heightLimit: 100, thrillLevel: 2, waitMinutes: 12,
    rating: 4.1, hasEasterEgg: false, chapter: 'spring',
    description: '어린이도 탈 수 있는 입문용 코스터.',
    icon: '🚂', isOperating: true,
  ),
  Attraction(
    id: 'x_flyer',
  ...
  Attraction(
    ...
    category: '어트랙션',
    zone: '모험의 나라',
    lat: 37.4338, lng: 127.0208,
    indoor: false, heightLimit: 110, thrillLevel: 3, waitMinutes: 15,
    rating: 4.0, hasEasterEgg: false, chapter: 'summer',
    description: '음악에 맞춰 회전하는 원반형 라이드.',
    icon: '💿', isOperating: true,
  ),
  Attraction(
    id: 'mini_viking',
  ...
  Attraction(
    ...
    category: '어트랙션',
    zone: '모험의 나라',
    lat: 37.4340, lng: 127.0214,
    indoor: false, heightLimit: 110, thrillLevel: 3, waitMinutes: 14,
    rating: 4.0, hasEasterEgg: false, chapter: 'summer',
    description: '수면 위를 튕기듯 달리는 보트 어트랙션.',
    icon: '🚤', isOperating: true,
  ),
  Attraction(
    id: 'sinbad_adventure',
    ...
    category: '어트랙션',
    zone: '모험의 나라',
    lat: 37.4343, lng: 127.0207,
    indoor: true, heightLimit: 0, thrillLevel: 2, waitMinutes: 10,
    rating: 4.2, hasEasterEgg: true, chapter: 'winter',
    description: '동굴 속 항해 다크 라이드.',
    icon: '🧞', isOperating: true,
  ),
  Attraction(
  ...
  Attraction(
    ...
    category: '어트랙션',
    zone: '세계의 광장',
    lat: 37.4339, lng: 127.0192,
    indoor: false, heightLimit: 0, thrillLevel: 1, waitMinutes: 12,
    rating: 4.0, hasEasterEgg: true, chapter: 'spring',
    description: '공중에서 서울랜드 전경을 한 바퀴.',
    icon: '🚝', isOperating: true,
  ),
  Attraction(
    id: 'spinning_cup',
    ...
    category: '어트랙션',
    zone: '캐릭터 타운',
    lat: 37.4334, lng: 127.0190,
    indoor: false, heightLimit: 0, thrillLevel: 2, waitMinutes: 7,
    rating: 4.0, hasEasterEgg: false, chapter: 'spring',
    description: '돌리면 돌릴수록 빨라지는 회전 컵.',
    icon: '🍵', isOperating: true,
  ),
  // ─── 추가 음식점 (6) ────────────────────────────────────
  Attraction(
  ...
  Attraction(
    ...
    category: '음식점',
    zone: '캐릭터 타운',
    lat: 37.4331, lng: 127.0186,
    indoor: true, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 3.8, hasEasterEgg: false, chapter: null,
    description: '떡볶이·튀김·김밥 등 분식 모음.',
    icon: '🍢', isOperating: true,
  ),
  Attraction(
    id: 'galbi_house',
    ...
    category: '음식점',
    zone: '삼천리 동산',
    lat: 37.4348, lng: 127.0180,
    indoor: true, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 4.3, hasEasterEgg: false, chapter: null,
    description: '한우 양념갈비 정식.',
    icon: '🥩', isOperating: true,
  ),
  Attraction(
    id: 'ramen_house',
  ...
  Attraction(
    ...
    category: '음식점',
    zone: '미래의 나라',
    lat: 37.4349, lng: 127.0207,
    indoor: true, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 3.9, hasEasterEgg: false, chapter: null,
    description: '직접 뽑은 우동면.',
    icon: '🍲', isOperating: true,
  ),
  Attraction(
    id: 'hotdog_stand',
    ...
    category: '음식점',
    zone: '모험의 나라',
    lat: 37.4337, lng: 127.0212,
    indoor: false, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 3.8, hasEasterEgg: false, chapter: null,
    description: '아메리칸 콘도그.',
    icon: '🌭', isOperating: true,
  ),
  // ─── 추가 카페 (3) ──────────────────────────────────────
  Attraction(
    ...
    category: '카페',
    zone: '세계의 광장',
    lat: 37.4344, lng: 127.0190,
    indoor: true, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 4.1, hasEasterEgg: false, chapter: null,
    description: '31가지 아이스크림.',
    icon: '🍨', isOperating: true,
  ),
  Attraction(
    id: 'dunkin',
  ...
  Attraction(
    ...
    category: '카페',
    zone: '캐릭터 타운',
    lat: 37.4328, lng: 127.0188,
    indoor: false, heightLimit: 0, thrillLevel: 0, waitMinutes: 0,
    rating: 4.0, hasEasterEgg: false, chapter: null,
    description: '벨기에식 생크림 와플.',
    icon: '🧇', isOperating: true,
  ),
  // ─── 추가 포토스팟 (25) ─────────────────────────────────
  Attraction(

    ...
    return Container(
      ...
      child: const Row(
        children: [
          ...
          Icon(Icons.chevron_right_rounded, color: Color(0xFF9E9E9E), size: 20),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text('최저 12°C / 최고 21°C', style: TextStyle(fontSize: 11, color: Color(0xFF888888))),
          SizedBox(height: 2),
          Text('강수확률 5% | 과천, 경기도', style: TextStyle(fontSize: 11, color: Color(0xFF888888))),
        ],
      ),
    );
  }

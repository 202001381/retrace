...
class AppL10nEn extends AppL10n {
  ...
  @override String get home_today_discount_detail => "💰 See today's discount";
  @override String home_saving_today(String amount) => 'Saving ₩$amount today';
  @override String home_save_with_luna_ticket(String amount) => 'Save ₩$amount with Luna ticket';
  @override String home_wait_eta_short(int min) => '⏱ Est. wait $min min';
  @override String get rec_browse_all => '🎢 Browse all';
  @override String get rec_filter_operating => '✅ Operating';
  @override String get rec_filter_egg => '✨ Easter eggs';
  @override String rec_wait_eta_short(int min) => '⏱ ~$min min';
  @override String rec_zone_wait_eta(String zone, int min) => '$zone · ⏱ ~$min min';
  @override String nav_walk_eta_short(int min) => '~$min min walk';
  @override String route_custom_recommend(String companion) => 'Custom route for $companion';
  @override String route_stops_count(int count) => '🗺️ $count stops';
  @override String get route_ai_optimal => '🎯 AI optimal route';
  @override String checkout_luna_discount_pct(int pct) => 'Luna discount ($pct%)';
  @override String price_off_pct(int pct) => '$pct% off';
  @override String price_list_price(String price) => 'List ₩$price';
  @override String get attr_luna_finding_story => '🌙 Luna is finding the story...';
  @override String get narrative_found => 'Hidden memory fragment found!';
  @override String get narrative_placeholder => '[narrative]';
  @override String get narrative_save_chronicle => '📖 Save to Chronicle';
  @override String archive_photo_load_failed(String error) => "Couldn't load photo: $error";
  @override String map_nav_status(String name, int min) => '➜ $name ($min min walk)';
  @override String get map_filter_my_eggs => '✨ My eggs';
  @override String get nav_arrival_hint => "You don't need to watch the screen — we'll let you know when you're within 50m.";
  @override String nav_arrival_close(String name) => "🎯 Almost there! $name";
  @override String get discount_reason_weather => 'Cloudy = quiet';
  @override String get discount_reason_weekday => 'Weekday low season';
  @override String get discount_reason_low_demand => 'Quiet today';
  @override String get discount_reason_event => 'Event deal';
  @override String narrative_load_error(String error) => "Couldn't fetch the story. Please try again later.\n($error)";
  @override String get checkout_expired_title => 'Discount has expired';
  @override String checkout_pay_now(String amount) => 'Pay ₩$amount';
  @override String get checkout_locked_disclaimer => "💡 This discount is valid until the shown time. Pricing won't change after checkout.";
  @override String get cat_show => 'Shows';
  @override String get cat_facility => 'Facilities';
  @override String rec_thrill_level(int level) => 'Thrill $level/5';
  @override String get home_why_offer_prefix => 'Why Luna gives you ';
  @override String get home_why_offer_suffix => '\ntoday';
  @override String get myluna_stat_walk => 'Walk';
  ...
  @override String archive_chapter_label(String season) => '$season chapter';
  @override String get archive_bookshelf_title => 'Memory bookshelf';
  @override String get archive_bookshelf_subtitle => 'One book for each day you visited Seoul Land';
  @override String archive_books_count(int count) => '$count book${count == 1 ? '' : 's'}';
  @override String archive_date_full(int month, int day, String wd) => '$month/$day · $wd';
  @override String get archive_weekday_sun => 'Sun';
  @override String get archive_weekday_mon => 'Mon';
  @override String get archive_weekday_tue => 'Tue';
  @override String get archive_weekday_wed => 'Wed';
  @override String get archive_weekday_thu => 'Thu';
  @override String get archive_weekday_fri => 'Fri';
  @override String get archive_weekday_sat => 'Sat';
  @override String get archive_ch_02_log => 'CH · 02 · EXPEDITION LOG';
  @override String archive_visited_count(int count) => 'Visited $count place${count == 1 ? '' : 's'}';
  @override String get archive_no_attractions => 'No attractions recorded.';
  @override String get archive_todays_missions => "Today's missions";
  @override String get archive_earned_badges => 'Earned badges';
  @override String get archive_ch_03_memory => 'CH · 03 · MEMORY PAGE';
  @override String get archive_explore_success => "Today's exploration complete";
  @override String get archive_photo_gallery => 'Gallery';
  @override String get archive_photo_camera => 'Camera';
  @override String get archive_photo_replace => 'Replace';
  @override String get archive_photo_delete => 'Delete';
  @override String get archive_stat_collected => 'Memories collected';
  @override String get archive_stat_photo_attached => 'Photos attached';
  @override String get archive_stat_record_period => 'Record span';

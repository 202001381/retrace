...
class AppL10nKo extends AppL10n {
  ...
  @override String get home_today_discount_detail => '💰 오늘 할인 자세히 보기';
  @override String home_saving_today(String amount) => '오늘 $amount원 아끼는 중';
  @override String home_save_with_luna_ticket(String amount) => '루나 티켓 $amount원 아끼기';
  @override String home_wait_eta_short(int min) => '⏱ 예상 대기 $min분';
  @override String get rec_browse_all => '🎢 전체 둘러보기';
  @override String get rec_filter_operating => '✅ 운영중';
  @override String get rec_filter_egg => '✨ 이스터에그';
  @override String rec_wait_eta_short(int min) => '⏱ 예상 $min분';
  @override String rec_zone_wait_eta(String zone, int min) => '$zone · ⏱ 예상 $min분';
  @override String nav_walk_eta_short(int min) => '도보 약 $min분';
  @override String route_custom_recommend(String companion) => '$companion 맞춤 동선 추천';
  @override String route_stops_count(int count) => '🗺️ $count개 스팟';
  @override String get route_ai_optimal => '🎯 AI 최적 동선';
  @override String checkout_luna_discount_pct(int pct) => '루나 할인 ($pct%)';
  @override String price_off_pct(int pct) => '$pct% 할인';
  @override String price_list_price(String price) => '정가 ₩$price';
  @override String get attr_luna_finding_story => '🌙 루나가 이야기를 찾고 있어요...';
  @override String get narrative_found => '숨겨진 기억의 조각 발견!';
  @override String get narrative_placeholder => '[서사 텍스트]';
  @override String get narrative_save_chronicle => '📖 연대기(Chronicle)에 수집하기';
  @override String archive_photo_load_failed(String error) => '사진을 가져오지 못했어요: $error';
  @override String map_nav_status(String name, int min) => '➜ $name (도보 $min분)';
  @override String get map_filter_my_eggs => '✨ 내 이스터에그';
  @override String get nav_arrival_hint => '폰을 보지 않으셔도 돼요 — 50m 안으로 들어가면 알려드릴게요.';
  @override String nav_arrival_close(String name) => '🎯 거의 다 왔어요! $name';
  @override String get discount_reason_weather => '흐려서 한산';
  @override String get discount_reason_weekday => '평일 비수기';
  @override String get discount_reason_low_demand => '오늘 한산';
  @override String get discount_reason_event => '이벤트 특가';
  @override String narrative_load_error(String error) => '서사를 가져오지 못했어요. 잠시 후 다시 시도해주세요.\n($error)';
  @override String get checkout_expired_title => '할인이 만료됐어요';
  @override String checkout_pay_now(String amount) => '₩$amount 결제하기';
  @override String get checkout_locked_disclaimer => '💡 이 할인은 표시된 시간까지 유효해요. 결제 후엔 가격 변동의 영향을 받지 않아요.';
  @override String get cat_show => '공연';
  @override String get cat_facility => '편의시설';
  @override String rec_thrill_level(int level) => '스릴 $level/5';
  @override String get home_why_offer_prefix => '오늘 루나가 ';
  @override String get home_why_offer_suffix => '\n드리는 이유';
  @override String get myluna_stat_walk => '도보';
  ...
  @override String archive_chapter_label(String season) => '$season 챕터';
  @override String get archive_bookshelf_title => '기억의 책장';
  @override String get archive_bookshelf_subtitle => '서울랜드를 찾은 날들이 한 권씩 쌓이고 있어요';
  @override String archive_books_count(int count) => '$count권';
  @override String archive_date_full(int month, int day, String wd) => '$month월 $day일 · $wd요일';
  @override String get archive_weekday_sun => '일';
  @override String get archive_weekday_mon => '월';
  @override String get archive_weekday_tue => '화';
  @override String get archive_weekday_wed => '수';
  @override String get archive_weekday_thu => '목';
  @override String get archive_weekday_fri => '금';
  @override String get archive_weekday_sat => '토';
  @override String get archive_ch_02_log => 'CH · 02 · 탐험 일지';
  @override String archive_visited_count(int count) => '$count곳을 거쳤어요';
  @override String get archive_no_attractions => '기록된 어트랙션이 없어요.';
  @override String get archive_todays_missions => '오늘의 미션';
  @override String get archive_earned_badges => '획득한 뱃지';
  @override String get archive_ch_03_memory => 'CH · 03 · 추억의 장';
  @override String get archive_explore_success => '오늘의 탐험 성공';
  @override String get archive_photo_gallery => '갤러리';
  @override String get archive_photo_camera => '촬영';
  @override String get archive_photo_replace => '사진 변경';
  @override String get archive_photo_delete => '삭제';
  @override String get archive_stat_collected => '수집한 추억';
  @override String get archive_stat_photo_attached => '사진 첨부';
  @override String get archive_stat_record_period => '기록 기간';
